...
namespace Client.Pages.Admin.Orders
{
    public class ProcessingModel : PageModel
    {
        ...
        public ProcessingModel (OrderService orderService, IHttpContextAccessor contextAccessor) {
        ...
        public async Task<IActionResult> OnGetAsync () {
            ...
            OrderModels = await _orderService.GetOrdersByStatusAsync ("Processing");
            return Page ();
        }
